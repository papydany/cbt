...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div class="row">
          ...
          <div class="col-sm-6">
            <form  method="POST" action="{{ url('update_question') }}" data-parsley-validate>
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                 ...
                 <textarea name="question">{!! $q->body !!}</textarea>                 
                  </div>
                  <!-- /.input group -->
                </div>
              ...
              <div class="card-body">
                ...
                <table class="table">
                  <tr>
                    ...
                    <th>Options And Checked the Right Option</th>
                    
                  </tr>
                   <?php $option =$R->Getoption($q->id) ;
                   $i = 1;
                    ...
                    <td> 
                      ...
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                          @if($v->answer == 1)
                           <input type="radio" name="answer" value="{{$v->id}}" checked>
                          @else
                           <input type="radio" name="answer" value="{{$v->id}}">
                          @endif
                         
                        </span>
                      </div>
                      <input type="text" class="form-control" name="option[{{$v->id}}]" value="{{$v->option}}" required>
                    </div></td>
