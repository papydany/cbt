  ...
  <div class="content-wrapper">
    ...
    <div class="row">
         <div class="col-sm-12 card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                   <form class="form-horizontal" role="form" method="POST" action="{{ url('view_students') }}" data-parsley-validate>
                        {{ csrf_field() }}
                ...
                <table class="table table-bordered">
                 ...
                 <tbody>
                  {{!!$c = 0}}
                  @foreach($ss as $v)
                  <?php $gss =$r->getStudentSubject($v->id); ?>
                  <tr>
                    <td>{{++ $c}}.</td>
                    <td>{{$v->name}}</td>
                    <td>{{$v->email}}</td>
